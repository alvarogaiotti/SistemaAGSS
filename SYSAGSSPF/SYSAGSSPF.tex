...
\begin{center}
    ...
    {\Huge
        ...
        \begin{bidtable}
            \+\+\\
            1\texttt{c} \> 2+\texttt{c}\ 11--21\\
            1\texttt{d} \> 4+\texttt{d}\ 11-21\\
            1\texttt{h} \> 5+\texttt{h}\ 11-21\\
            1\texttt{S} \> 5+\texttt{S}\ 11-21\\
            1SA \> (14)15-17 BIL\\
            2\texttt{c} \> FM o 22+ BIL\\
            2\texttt{d} \> 18-19 BIL\\
            2\texttt{h}/\texttt{S} \> 6+\texttt{h} /\texttt{S} , 5--9\\
            2SA \> 20--21 BIL\\
            3X \> Barrage\\
            3SA \> Buon 4\texttt{h} /\texttt{S}\\
        \end{bidtable}
    }
\end{center}
