...
\begin{itemize}
    ...
    \item Più lunghi siamo a \Sp o \He più siamo aggressivi. E.g. la mano \ref{fig:mano1} è un 2\BH\ migliore della \ref{fig:mano2}
...
\begin{figure}[h]
    ...
    \begin{subfigure}[b]{.4\textwidth}
        ...
        \caption{Mano 1}\customlabel{fig:mano1}{mano 1}
    \end{subfigure}
    \begin{subfigure}[b]{.4\textwidth}
        \centering
        \hand!{x}{QTxxxx}{Kxx}{xxx}

        \caption{Mano 2}\customlabel{fig:mano2}{mano 2}
    \end{subfigure}
\end{figure}
...
\begin{multicols}{2}
    ...
    \begin{attenzione}{\textbf{REGOLA}}
        Sse la seconda surlicita a salto non lascia almeno un colore giocabile a livello 3, allora è FM e non IM+.
    \end{attenzione}
